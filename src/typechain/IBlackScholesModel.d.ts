...
interface IBlackScholesModelInterface extends ethers.utils.Interface {
  functions: {
...
export class IBlackScholesModel extends Contract {
  ...
  interface: IBlackScholesModelInterface;
